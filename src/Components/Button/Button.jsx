...
function Button({API_key,USER_name}) {
  ...
  return (
    <>
      <button type='submit' className='w-full h-[50px] bg-primary font-Poppins font-extrabold text-slate-50 rounded-md cursor-pointer hover:bg-[#404040] duration-200 'onClick={handleUpdateLocalStorage}>Let's fly</button>
